...
class _CreateAccountState extends State<CreateAccount> {
  ...
  Future<Null> checkPermission() async {
    ...
    if (locationService) {
      ...
      if (locationPermission == LocationPermission.denied) {
        ...
        if (locationPermission == LocationPermission.deniedForever) {
          MyDialog().alertLocationService(
              context, 'ไม่อนุญาตแชร์ Locacion', 'โปรดแชร์ Location');
        } else {
          // Find LatLang
          findLatLng();
        }
      ...
      MyDialog().alertLocationService(context, 'Location Service ปิดอยู่',
          'กรุณาเปิด Location Service ก่อนใช้งาน');
    }
  }
        ...
        if (formKey.currentState!.validate()) {
          if (typUser == null) {
            ...
            MyDialog().normalDialog(context, 'ยังไม่ได้เลือกชนิด User',
                'กรุณาเลือกชนิด User ที่ต้องการ');
          } else {
  ...
  Future<Null> processInsertMySQL(
    ...
    String apiInsertUser =
        '${MyConstant.domain}/shoppingmall/insertUser.php?isAdd=true&name=$name&type=$typUser&address=$address&phone=$phone&user=$user&password=$password&avatar=$avatar&lat=$lat&lng=$lng';
